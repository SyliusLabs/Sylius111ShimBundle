...
final class LegacyRequest implements LegacyRequestInterface
{
    ...
    public static function subResourceIndex(?string $section, string $resource, string $id, string $subResource): LegacyRequestInterface
    {
        return new self(
    ...
    public static function transition(?string $section, string $resource, string $id, string $transition): LegacyRequestInterface
    {
        return self::customItemAction($section, $resource, $id, HttpRequest::METHOD_PATCH, $transition);
    }

    public static function customItemAction(?string $section, string $resource, string $id, string $type, string $action): LegacyRequestInterface
    {
        return new self(
    ...
    public static function custom(string $url, string $method, ?string $token = null): LegacyRequestInterface
    {
